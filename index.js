...
const beebo_port = process.env.PORT || 8080 || 5000 || 3000
...
app.post('/send-message', async (req, res) => {
  ...
  if (wa.state === "open") {
		...
		if (exists) {
		  wa.sendMessage('6281247374916@s.whatsapp.net', '-----> Beebo Sending messages to ${exists}', MessageType.text)
